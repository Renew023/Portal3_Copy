...
public class GizmoRotationHandle : MonoBehaviour
{
    Camera _camera;
    [SerializeField]
    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButton(0) && selectedHandle == gameObject)
        {
            ...
            float rotationSpeed = rotateSpeed * 10f;
            float rotationAmount = signedAmount * rotationSpeed * Time.deltaTime;

            gizmoUI.RotateTarget(axis, rotationAmount);
        }
